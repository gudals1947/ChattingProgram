...
public class APIExamSearchNews {
	...
	public void searchNews(String search) {
		...
		try {
			...
			String apiURL = "https://openapi.naver.com/v1/search/news?query=" + text + "&sort=" + sort; // json 결과
	...
	public void searchNews(String search, String sort) {
		// TODO Auto-generated method stub
		this.sort = sort;
		String clientId = "2j2upZhjOkmF_S7DA3lX";// 애플리케이션 클라이언트 아이디값";
		String clientSecret = "_f3QPIbUxO";// 애플리케이션 클라이언트 시크릿값";
		try {
			pubDate.removeAll(pubDate);
			String text = URLEncoder.encode(search, "UTF-8");
			String apiURL = "https://openapi.naver.com/v1/search/news?query=" + text + "&sort=" + this.sort; // json 결과
			// String apiURL = "https://openapi.naver.com/v1/search/blog.xml?query="+ text;
			// // xml 결과
			URL url = new URL(apiURL);
			HttpURLConnection con = (HttpURLConnection) url.openConnection();
